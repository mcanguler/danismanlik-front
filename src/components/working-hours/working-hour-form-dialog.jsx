...
export function WorkingHourFormDialog({ open, workingHour, onOpenChange }) {
  ...
  const form = useForm({
    ...
    defaultValues: toFormValues(workingHour),
  });
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
            {isEdit ? "Çalışma Saatini Düzenle" : "Yeni Çalışma Saati"}
          </DialogTitle>
          <DialogDescription>
            {isEdit
              ? `${workingHour.consultantName} · ${dayLabel(workingHour.day_of_week)} ${workingHour.start_time}-${workingHour.end_time}`
              : "Danışman için çalışma saati tanımlayın"}
          </DialogDescription>
        </DialogHeader>
